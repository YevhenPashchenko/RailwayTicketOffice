...
public class Ticket implements Serializable {
    ...
    public void setTicketNumber() {
        ...
        ticketNumber = seatNumber + "-" + joinedDepartureDateTime + "-" + joinedDestinationDateTime;
    }
    ...
    public boolean equals(Object o) {
        ...
        return seatNumber == ticket.seatNumber && Objects.equals(ticketNumber, ticket.ticketNumber) && Objects.equals(trainNumber, ticket.trainNumber) && Objects.equals(departureStation, ticket.departureStation) && Objects.equals(destinationStation, ticket.destinationStation) && Objects.equals(departureDateTime, ticket.departureDateTime) && Objects.equals(destinationDateTime, ticket.destinationDateTime) && Objects.equals(passengerSurname, ticket.passengerSurname) && Objects.equals(passengerName, ticket.passengerName) && Objects.equals(cost, ticket.cost);
    }

    @Override
    public int hashCode() {
        return Objects.hash(ticketNumber, trainNumber, seatNumber, departureStation, destinationStation, departureDateTime, destinationDateTime, passengerSurname, passengerName, cost);
    }
}
