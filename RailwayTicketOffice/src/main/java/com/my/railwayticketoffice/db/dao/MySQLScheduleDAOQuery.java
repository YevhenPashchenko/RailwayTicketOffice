...
public class MySQLScheduleDAOQuery {
    ...
    public static final String DELETE_TRAIN_FROM_SCHEDULE = "DELETE FROM railwayticketofficedb.schedules WHERE train_id = ?";
    ...
    public static final String EDIT_CARRIAGE_DATA = "UPDATE railwayticketofficedb.schedules SET carriage_id = ? WHERE train_id = ?";
}
