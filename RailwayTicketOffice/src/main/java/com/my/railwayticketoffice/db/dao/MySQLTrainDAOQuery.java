...
public class MySQLTrainDAOQuery {
    ...
    public static final String GET_FREE_SEATS_FOR_TRAINS_BY_DATE = "SELECT train_id, carriage_id, seat_number " +
            "FROM railwayticketofficedb.schedules WHERE day = ? AND user_id IS NULL AND train_id in ";
    ...
    public static final String EDIT_CARRIAGE_NUMBER_IN_TRAIN = "UPDATE railwayticketofficedb.trains_carriages SET carriage_id = ? WHERE train_id = ? AND carriage_id = ?";
