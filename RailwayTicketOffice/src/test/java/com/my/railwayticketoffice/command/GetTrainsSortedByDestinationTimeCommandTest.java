...
/**
 * Tests for methods from {@link GetTrainsSortedByDestinationTimeCommand}
 *
 * @author Yevhen Pashchenko
 */
public class GetTrainsSortedByDestinationTimeCommandTest {
    ...
    /**
     * Test for method execute from {@link GetTrainsSortedByDestinationTimeCommand}.
     *
    ...
    public void testExecute() throws Exception {
        ...
        assertEquals("controller?command=mainPage", new GetTrainsSortedByDestinationTimeCommand().execute(request, response));
