...
/**
 * Tests for methods from {@link GetTrainsSortedByDepartureTimeCommand}
 *
 * @author Yevhen Pashchenko
 */
public class GetTrainsSortedByDepartureTimeCommandTest {
    ...
    /**
     * Test for method execute from {@link GetTrainsSortedByDepartureTimeCommand}.
     *
    ...
    public void testExecute() throws Exception {
        ...
        assertEquals("controller?command=mainPage", new GetTrainsSortedByDepartureTimeCommand().execute(request, response));
