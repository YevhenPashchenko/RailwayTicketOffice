...
/**
 * Tests for methods from {@link GetTrainsSortedByDurationTripCommand}
 *
 * @author Yevhen Pashchenko
 */
public class GetTrainsSortedByDurationTripCommandTest {
    ...
    /**
     * Test for method execute from {@link GetTrainsSortedByDurationTripCommand}.
     *
    ...
    public void testExecute() throws Exception {
        ...
        assertEquals("controller?command=mainPage", new GetTrainsSortedByDurationTripCommand().execute(request, response));
